<template>
	<view class="uni-load-more" @click="onClick">
		...
		<text v-if="showText" class="uni-load-more__text"
			:style="{color: color}">
			{{ status === 'more' ? contentdownText : status === 'loading' ? contentrefreshText : contentnomoreText }}</text>
	</view>
</template>
...
<script>
	...
	export default {
		...
		computed: {
			...
			contentdownText() {
				// if(this.lang=="tai"){
				// 	return this.contentText.contentdown || t("uni-load-more.contentdown-th")
				// }
				return this.contentText.contentdown || this.$t("uni-load-more.contentdown")
			},
			contentrefreshText() {
				//console.log("========lang222=====",t.locale);
				console.log("========lang222=====",this.lang);
				// if(this.lang=="tai"){
				// 	return this.contentText.contentrefresh || t("uni-load-more.contentrefresh-th")
				// }
				return this.contentText.contentrefresh || this.$t("uni-load-more.contentrefresh")
			},
			contentnomoreText() {
				//console.log("========lang333=====",t.locale);
				console.log("========lang333=====",this.lang);
				// if(this.lang=="tai"){
				// 	return this.contentText.contentnomore || t("uni-load-more.contentnomore-th")
				// }
				return this.contentText.contentnomore || this.$t("uni-load-more.contentnomore")
			}
		},
		mounted() {
			// #ifdef APP-PLUS
			...
			// 	console.log("========lang2=====",data.lang);
			// 	that.lang = data.lang
			// 	that.$i18n.locale=data.lang
			// })
